...
import { ArrowBigDown, Menu, ShoppingCart } from "lucide-react";
      ...
      <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
        ...
        <nav className="hidden gap-8 lg:flex 2xl:ml-16">
          ...
          >
            ...
            {dclicked && (
            <div className="bg-gray-200 absolute top-8 z-30 shadow-lg p-5 w-[270px]">
        ...
        <div className="flex divide-x border-r sm:border-l">
          ...
          >
            <div className="absolute right-50 top-0 text-primary font-semibold text-sm md:text-lg">
              {cartCount}
            </div>
            <ShoppingCart />
